...
public class MoonTest {
	...
	public static void main(String[] args) {
  		...
  		new MoonTest().pheno(args);
//  		new MoonTest().heliacal_pheno(args);
	}

  	private void pheno(String[] argv) {
		...
		long iflag = SweConst.SEFLG_TRUEPOS | SweConst.SEFLG_HELCTR;
  		...
  		sweph.swe_pheno_ut(tjdet, SweConst.SE_MOON, (int)iflag, xx, sb);
  	...
  	private void heliacal_pheno(String[] argv) {
  		...
  		new SweHel().swe_heliacal_pheno_ut(tjdet, dgeo, datm, dobs, new StringBuffer("Moon"), SweConst.SE_HELIACAL_RISING, SweConst.SE_HELFLAG_OPTICAL_PARAMS, xx, sb);
